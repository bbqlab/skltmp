...
PAYMENTS_PLANS = {
    "basic": {
        ...
        "name": "Skillup Basic ($2/month with 15 days free)",
    ...
    "full": {
        "stripe_plan_id": "full",
        "name": "Skillup FULL ($2/month with 15 days free)",
        "description": "The monthly subscription plan to WebApp",
        "price": 10,
        "currency": "eur",
        "interval": "month",
...
AUTH_PROFILE_MODEL = "shop.Customer"
...
PASSWORD_HASHERS = (
    'skillup.hashers.LhSHA1PasswordHasher',
...
#SHOP_CURRENCY_LOCALE = 'it_IT.utf8'
